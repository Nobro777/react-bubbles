...
a token is used to identify an individual user when they log in 
- [ ] What steps can you take in your web apps to keep your data secure?
you can use local storage with authentication and use private routes 
- [ ] Describe how web servers work.
web servers are hosted online through sites like zeit, heroku etc 
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
put + delete + get // Create Read Update Delete = CRUD 
